...
# ADDED: User input for Annual Drift
...
volatility = 0.15
# MODIFIED: Corrected function call with all arguments (TypeError fix)
...
# FIX: Corrected column count (ValueError fix)
...
st.markdown("---")
# MODIFIED: Added author attribution
st.caption(f"Dashboard generated by **Theo Douwes** | {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} | Simulated data")
